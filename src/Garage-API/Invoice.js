      ...
      <div className="box-1">
        ...
        <Formik
          ...
          onSubmit={async (values) => {
            axios
              .post(
                "https://garage-node-gioc.onrender.com/invoice/create",
                values,
                {
        ...
        >
          <Form className="d-flex flex-column">
            <label htmlFor="totalCost" className="fw-bold">
              totalCost :{" "}
            </label>
            <Field
              id="totalCost"
            ...
            <label htmlFor="paymentStatus" className="fw-bold">
              paymentStatus :
            </label>
            <Field
              id="paymentStatus"
            ...
            <label htmlFor="paymentDate" className="fw-bold">
              paymentDate :
            </label>
            <Field
              id="paymentDate"
