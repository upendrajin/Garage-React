                  ...
                  service.map((el, index) => {
                    return <div className='col-4'>
                      ...
                      <Card style={{ width: '363px' }} key={index} onClick={card} className='p-0 box pos-rel '>
                        <div className="img-box border-bottom"><Card.Img variant="top" className='p-0' src={'https://blog-node-1.onrender.com/images/' + el.image} /></div>
                        <Card.Body>
              ...
              service.map((el, index) => {
                return <div className="col-4 box p-0 bg-white m-3 bor" key={index} onClick={card}>
                  ...
                  <div className=" text-dark pos-rel">
                    ...
                    <div className="img-box"><img className='w-100' src={'https://blog-node-1.onrender.com/images/' + el.image} alt="" /></div>
                    <div className='p-3'>
